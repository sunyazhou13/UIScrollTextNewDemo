...
- (void)viewDidLoad {
    ...
    self.scrollTextView1.font = textFont;
    self.scrollTextView1.backgroundColor = [UIColor whiteColor];
    ...
    NSString *text = @"sunyazhou.com - 迈腾大队长";
    [self.scrollTextView1 setText:text];
    CGSize textSize = [text calculateSingleLineSizeFromFont:textFont];
    UIImage *gradientImage = [YZUtilTool gradientFromColor:[UIColor cyanColor] toColor:[UIColor yellowColor] andSize:textSize];
    [self.scrollTextView1 setTextColor:[UIColor colorWithPatternImage:gradientImage]];
